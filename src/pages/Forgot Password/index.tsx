...
const ForgotPassword: React.FC = () => {
  // criando o loading para quando enviar o e-mail
  ...
  const handleSubmit = useCallback(
    async (data: ForgotPasswordFormData) => {
      try {
        ...
        // chamando a rota da api para trocar o e-mail
        await api.post('/password/forgot', {
          email: data.email,
        });
        // mandando uma mensagem de sucesso
        addToast({
          type: 'success',
        ...
        }); // terminamos o loading aqui no final, pois é o melhor momento
      } finally {
        setLoading(false);
      }
    },
